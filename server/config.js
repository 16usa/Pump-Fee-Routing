...
export const config = Object.freeze({
  ...
  userSignedLaunchEnabled: bool('USER_SIGNED_LAUNCH_ENABLED', false),
  ...
  pumpMetadataUrlTemplate: process.env.PUMP_METADATA_URL_TEMPLATE || 'https://frontend-api-v3.pump.fun/coins-v2/{mint}',
  pumpMetadataUploadUrl: process.env.PUMP_METADATA_UPLOAD_URL || 'https://pump.fun/api/ipfs',
  pumpCreateApiUrl: process.env.PUMP_CREATE_API_URL || 'https://fun-block.pump.fun/agents/create-coin',
  ...
  xSessionSecret: process.env.X_SESSION_SECRET || '',
