...
function header(){return `<header class="topbar"><div class="topbar-inner">${logo()}<nav class="desktop-nav"><a href="#/explore">Explore</a><a href="#/money">Money</a><a href="#/capital-flow">Capital flow</a><a href="#/docs">Docs</a></nav><div class="top-actions"><a class="launch-pill" href="#/launch">Launch</a><button class="menu-btn" data-action="menu" aria-label="Menu"><i></i><i></i></button></div></div><div class="mobile-menu hidden" id="mobileMenu"><a href="#/explore">Explore</a><a href="#/money">Money</a><a href="#/capital-flow">Capital flow</a><a href="#/paid">Protocol</a><a href="#/docs">Docs</a><a href="#/opt-out">Opt out</a><a href="#/legal">Legal</a></div></header>`;}
